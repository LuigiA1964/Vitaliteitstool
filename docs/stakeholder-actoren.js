...
// ==========================================
// ARCHETYPEN — 12 Archetypische Vastgoedeigenaren
// Bron: City Deal Dynamische Binnensteden — "Vastgoed Vertaald"
// Projectteam: Gemeente Eindhoven, Fontys Hogeschool & Arno Ruigrok
// ==========================================
...
const ARCHETYPE_CATEGORIES = {
  ...
  ONDERNEMER_ZAKELIJK: 'ondernemer_zakelijk',
  ONDERNEMER_PERSOONLIJK: 'ondernemer_persoonlijk',
  PARTICULIER_ZAKELIJK: 'particulier_zakelijk',
  PARTICULIER_PERSOONLIJK: 'particulier_persoonlijk',
  GEMEENTE_BEHEERDER: 'gemeente_beheerder',
  GEMEENTE_ONTWIKKELAAR: 'gemeente_ontwikkelaar'
};
...
const ARCHETYPES = [
  {
    ...
    category: ARCHETYPE_CATEGORIES.INSTITUTIONEEL,
    order: 1,
    icon: '♟️',
    kernwaarde: 'Stabiliteit',
    quote: 'Wij investeren met een langetermijnvisie, gericht op stabiliteit en duurzame groei. Onze focus ligt altijd op het creëren van waarde voor de toekomst.',
    sleutelwoord: 'Inzicht',
    eigenschappen: ['Analytisch', 'Rationeel', 'Behoedzaam', 'Professioneel'],
    description: 'De Strateeg is een doelgerichte vastgoedinvesteerder die koersvast opereert met een lange termijn focus op zoek naar zekerheid. Met scherpe analyses en gestructureerde besluitvorming ontwikkelt hij robuuste vastgoedstrategieën die niet alleen rendement opleveren, maar ook bijdragen aan brede maatschappelijke waarde.',
    typeDescription: 'Een institutionele investeerder is een organisatie of instelling die namens anderen kapitaal beheert en investeert, zoals pensioenfondsen, verzekeraars of beleggingsinstellingen. Zij worden gezien als financiële instellingen en vallen onder strikte wet- en regelgeving op het gebied van transparantie, duurzaamheid en verantwoord beleggen.',
    kenmerken: [
      'Beleggen kapitaal van derden (pensioenpremies, verzekeringsgelden)',
      'Langetermijnhorizon (>10 jaar), gericht op stabiliteit',
      'Investeren veelal in A-locaties en stabiele sectoren',
      'Professioneel, transparant en datagedreven beheer',
      'Onderworpen aan wet- en regelgeving, inclusief ESG-verplichtingen',
      'Beleggen zowel direct (in vastgoed) als indirect (via fondsen)',
      'Strategische en proactieve aanpak in beheer en ontwikkeling'
    ],
    waaromVastgoed: [
      'Stabiele huurinkomsten: gericht op een voorspelbare kasstroom',
      'Waardeontwikkeling op lange termijn door strategische investeringen',
      'Risicospreiding: investeren in verschillende vastgoedtypes en regio\'s',
      'Verantwoord en duurzaam beleggen: voldoen aan ESG-criteria',
      'Beschermen van kapitaal: vastgoed als relatief veilige investering'
    ],
    needToKnow: 'Institutionele investeerders opereren zelden direct. In de praktijk ga je vaak niet in gesprek met het pensioenfonds of de verzekeraar zelf, maar met een tussenpersoon zoals een investment manager, uitvoeringsorganisatie of asset manager die het vastgoed namens hen beheert.',
    voorbeelden: ['ABP', 'PFZW', 'bpfBOUW', 'Achmea Investment Management', 'NN Group', 'Bouwinvest']
  },
  {
    id: 'NAVIGATOR',
    name: 'De Navigator',
    type: 'Vastgoedfonds',
    category: ARCHETYPE_CATEGORIES.FONDS,
    order: 2,
    icon: '🧭',
    kernwaarde: 'Rendement',
    quote: 'We navigeren zorgvuldig tussen rendement en het doen van verantwoorde investeringen, met focus op een lange termijn impact.',
    sleutelwoord: 'Strategie',
    eigenschappen: ['Strategisch', 'Professioneel', 'Oplossingsgericht', 'Avontuurlijk'],
    description: 'De Navigator heeft een scherp kompas en beweegt zich met visie en flexibiliteit door het dynamische speelveld van de vastgoedmarkt. Hij verkent routes, anticipeert op veranderingen en maakt strategische keuzes die inspelen op kansen én risico\'s.',
    typeDescription: 'Een vastgoedfonds is een organisatie die kapitaal van meerdere beleggers bundelt om gezamenlijk te investeren in vastgoed. Het fonds wordt professioneel beheerd en richt zich op rendement uit huurinkomsten én waardegroei, vaak binnen een duidelijke strategie.',
    kenmerken: [
      'Belegt met kapitaal van meerdere beleggers (particulier of institutioneel)',
      'Gestructureerd in open of gesloten fondsen, vaak met minimuminleg',
      'Gericht op één of meerdere vastgoedsectoren',
      'Professioneel, actief en transparant beheer van de portefeuille',
      'Risicoprofiel: laag tot gemiddeld, afhankelijk van fondsstrategie',
      'Beleggingshorizon varieert van middellang (5 jaar) tot lang (10+ jaar)',
      'Heldere dividend- of uitkeringsstructuur voor investeerders'
    ],
    waaromVastgoed: [
      'Stabiele huurinkomsten voor continu rendement',
      'Waardegroei van de portefeuille door optimalisatie en renovaties',
      'Risicospreiding: mix van vastgoedtypes en regio\'s',
      'Toegankelijkheid tot vastgoedmarkt voor beleggers',
      'Efficiënt en schaalbaar beheer door vastgoedprofessionals'
    ],
    needToKnow: 'Veel vastgoedfondsen zijn niet direct toegankelijk voor het brede publiek. De toegang verloopt vaak via een tussenpersoon, vermogensbeheerder of adviseur — vooral bij gesloten fondsen of fondsen met een hoge minimuminleg.',
    voorbeelden: ['Wereldhave', 'Eurocommercial', 'Unibail-Rodamco-Westfield', 'Annexum', 'Orange Capital Partners']
  },
  {
    id: 'BESCHERMER',
    name: 'De Beschermer',
    type: 'Family Office',
    category: ARCHETYPE_CATEGORIES.FAMILY_OFFICE,
    order: 3,
    icon: '🛡️',
    kernwaarde: 'Behoud',
    quote: 'We zetten ons vermogen duurzaam in, zodat we waarde kunnen waarborgen voor de komende generaties, zonder concessies te doen aan onze principes.',
    sleutelwoord: 'Continuïteit',
    eigenschappen: ['Zorgvuldig', 'Betrouwbaar', 'Verantwoordelijk', 'Standvastig'],
    description: 'De Beschermer handelt vanuit visie, verantwoordelijkheid en strategisch inzicht. Hij volgt een zorgvuldig uitgestippelde koers en neemt doelgerichte beslissingen die passen bij de lange horizon van familiekapitaal. Hij streeft naar controle, stabiliteit en betekenisvolle groei.',
    typeDescription: 'Een Family Office is een organisatie die het vermogen van één of meerdere vermogende families beheert. Het doel is om het kapitaal te behouden en te laten groeien over meerdere generaties. Family Offices investeren vaak direct in vastgoed om lange termijn vermogensgroei te realiseren.',
    kenmerken: [
      'Belegt kapitaal van één of meerdere welgestelde families',
      'Direct vastgoedbezit zonder tussenkomst van externe beleggers',
      'Gericht op lange termijn beleggingen (meestal 10+ jaar)',
      'Flexibiliteit in vastgoedkeuzes, afgestemd op familiedoelen',
      'Meer persoonlijke benadering en controle over de portefeuille',
      'Vaak minder gediversifieerd dan grotere institutionele investeerders',
      'Risicoprofiel: laag tot gemiddeld, afhankelijk van familiedoelen'
    ],
    waaromVastgoed: [
      'Lange termijn vermogensgroei door strategische vastgoedkeuzes',
      'Behouden van controle en privacy: minder afhankelijkheid van derden',
      'Stabiele inkomstenstroom: duurzame huurinkomsten voor de familie',
      'Beheersbare risico\'s: investeren in goed begrepen markten',
      'Maatschappelijke impact: vastgoedprojecten met positieve bijdrage'
    ],
    needToKnow: 'Family offices hebben vaak een langetermijnvisie en kunnen flexibel investeren in projecten die maatschappelijke waarde creëren, zoals de herontwikkeling van verouderde gebieden of behoud van erfgoed. Ze hanteren een persoonlijke benadering.',
    voorbeelden: ['Kroonenberg Groep', 'Redevco', 'Timeless', 'De Hoge Dennen']
  },
  {
    id: 'VERBINDER',
    name: 'De Verbinder',
    type: 'Maatschappelijke organisatie',
    category: ARCHETYPE_CATEGORIES.MAATSCHAPPELIJK,
    order: 4,
    icon: '🤝',
    kernwaarde: 'Impact',
    quote: 'Samenwerken is de sleutel tot het creëren van echte waarde. Alleen door verbinding kunnen we duurzame impact maken op de samenleving.',
    sleutelwoord: 'Gemeenschap',
    eigenschappen: ['Optimistisch', 'Eerlijk', 'Loyaal', 'Taakgedreven'],
    description: 'De Verbinder wordt gedreven door de overtuiging dat samenwerking en verbinding de sleutel zijn tot een betere wereld voor iedereen. Hij richt zich op het opbouwen van bruggen tussen mensen en gemeenschappen, waarbij gelijkwaardigheid, inclusie en open communicatie centraal staan.',
    typeDescription: 'Een maatschappelijke organisatie bezit vastgoed met als doel maatschappelijke meerwaarde te creëren, zoals het bieden van huisvesting voor kwetsbare groepen of het ondersteunen van sociale, culturele of educatieve initiatieven.',
    kenmerken: [
      'Belegt in vastgoed met het oog op maatschappelijke impact, niet financieel rendement',
      'Vaak actief betrokken bij het beheer en de invulling van het vastgoed',
      'Richt zich op vastgoed in specifieke gemeenschappen of regio\'s',
      'Focus ligt op exploitatie van de organisatie en niet op het vastgoed',
      'Beleggingshorizon is vaak langdurig, gericht op blijvende impact'
    ],
    waaromVastgoed: [
      'Sociale huisvesting bieden voor kwetsbare groepen',
      'Maatschappelijke en culturele initiatieven ondersteunen',
      'Duurzaamheid bevorderen door verduurzaming en energie-efficiëntie',
      'Sociale integratie en gemeenschapsontwikkeling stimuleren',
      'Langdurige maatschappelijke waarde creëren zonder nadruk op financieel rendement'
    ],
    needToKnow: 'Maatschappelijke organisaties herbestemmen leegstaand vastgoed vaak tijdelijk voor sociale initiatieven, zoals lokale evenementen, educatieve programma\'s of duurzame projecten. Dit helpt niet alleen de leegstand te verminderen, maar bevordert ook de sociale integratie.',
    voorbeelden: ['Leger des Heils', 'Gemeentelijke welzijnsorganisaties', 'Zorginstellingen', 'Culturele stichtingen']
  },
  {
    id: 'HOEDER',
    name: 'De Hoeder',
    type: 'Woningcorporatie',
    category: ARCHETYPE_CATEGORIES.CORPORATIE,
    order: 5,
    icon: '🏠',
    kernwaarde: 'Volkshuisvesting',
    quote: 'Onze verantwoordelijkheid is het bieden van een veilige en stabiele en betaalbare woonomgeving, met aandacht voor de behoeften van de bewoners.',
    sleutelwoord: 'Toegang',
    eigenschappen: ['Betrouwbaar', 'Behulpzaam', 'Geduldig', 'Verbindend'],
    description: 'Gedreven door maatschappelijke verantwoordelijkheid zet de Hoeder zich in voor het waarborgen van toegankelijke, betaalbare en duurzame woonruimte. Hij creëert een stabiele basis waarin mensen zich veilig en thuis voelen.',
    typeDescription: 'Woningcorporaties zijn non-profitorganisaties die verantwoordelijk zijn voor het beheren en ontwikkelen van betaalbare huurwoningen in Nederland. Ze hebben als doel om huisvesting beschikbaar te stellen voor mensen met een lagere of middeninkomen.',
    kenmerken: [
      'Non-profitorganisatie gericht op betaalbare huisvesting',
      'Beheren van zowel sociale huurwoningen als gemengde huurwoningen',
      'Focus op de lange termijn: duurzame en toekomstgerichte woningbouw',
      'Regelmatige samenwerking met lokale overheden en bewoners',
      'Onderworpen aan strikte wet- en regelgeving (bijv. de Woningwet)',
      'Actief betrokken bij de verduurzaming van het woningaanbod'
    ],
    waaromVastgoed: [
      'Betaalbare huisvesting bieden voor mensen met een lager inkomen',
      'Woningvoorraad verduurzamen',
      'Stabiele huurinkomsten voor herinvestering in woningbouw',
      'Woonkwaliteit verbeteren door renovaties en wijkvernieuwingen',
      'Maatschappelijke waarde creëren en leefbaarheid verbeteren'
    ],
    needToKnow: 'Woningcorporaties werken nauw samen met de gemeente en lokale stakeholders, en hebben vaak een belangrijke rol in wijkvernieuwingen. Ze zijn verantwoordelijk voor zowel het aanbieden van betaalbare woningen als het verbeteren van de leefbaarheid.',
    voorbeelden: ['Ymere', 'Woonbron', 'De Alliantie', 'Stichting Woonbedrijf']
  },
  {
    id: 'JAGER',
    name: 'De Jager',
    type: 'Private Equity',
    category: ARCHETYPE_CATEGORIES.PRIVATE_EQUITY,
    order: 6,
    icon: '🎯',
    kernwaarde: 'Waardecreatie',
    quote: 'Snel schakelen en de juiste kansen grijpen — dat is wat ons onderscheidt. Wij worden gedreven door resultaat en het behalen van waarde voor onze investeerders.',
    sleutelwoord: 'Snelheid',
    eigenschappen: ['Doelgericht', 'Volharding', 'Assertief', 'Resultaatgericht'],
    description: 'De Jager wordt gedreven door vastberadenheid en de wil om kansen te creëren, zelfs in de meest uitdagende omstandigheden. Hij handelt snel en doelgericht, zonder zich te laten afleiden door weerstand, en neemt risico\'s om zijn visie te verwezenlijken en winst te maximaliseren.',
    typeDescription: 'Private Equity (PE) is een investeringsvorm waarbij kapitaal van particuliere investeerders wordt gebundeld om vastgoed te verwerven, te optimaliseren en binnen 3-7 jaar met winst te verkopen.',
    kenmerken: [
      'Belegt met kapitaal van particuliere investeerders of institutionele partijen',
      'Richt zich op vastgoed met potentieel voor hoge rendementen door herontwikkeling',
      'Korte tot middellange termijn horizon (3-7 jaar)',
      'Actief in het beheer en herstructurering van vastgoed',
      'Risicobereidheid varieert van gemiddeld tot hoog'
    ],
    waaromVastgoed: [
      'Waardegroei: vastgoed wordt herontwikkeld voor meer waarde bij verkoop',
      'Hoge rendementen door waardevermeerdering en huuroptimalisatie',
      'Actief beheer om efficiëntie te verhogen en kosten te verlagen',
      'Korte termijn horizon: vastgoed 3-7 jaar aangehouden voor winst',
      'Risicospreiding: diversificatie in vastgoedtypes en markten'
    ],
    needToKnow: 'Private equity vastgoedbeleggers richten zich vaak op value-add-strategieën, waarbij zij onbenut potentieel in vastgoed herontdekken en benutten. Dit kan door renovaties, herontwikkeling of het optimaliseren van bestaande huurcontracten.',
    voorbeelden: ['Blackstone', 'Brookfield Asset Management', 'KKR', 'PQR', 'Mississippi Ventures']
  },
  {
    id: 'REBEL',
    name: 'De Rebel',
    type: 'Ondernemer-eigenaar | zakelijk',
    category: ARCHETYPE_CATEGORIES.ONDERNEMER_ZAKELIJK,
    order: 7,
    icon: '⚡',
    kernwaarde: 'Onafhankelijkheid',
    quote: 'Ik neem de touwtjes in handen, kies mijn eigen pad en durf te vernieuwen. Ondernemen is risico nemen, maar ook kansen grijpen waar anderen aarzelen.',
    sleutelwoord: 'Vrijheid',
    eigenschappen: ['Onafhankelijk', 'Vrijgevochten', 'Doorzetter', 'Doener'],
    description: 'De Rebel laat zich niet tegenhouden door traditionele normen of conventies. Met een heldere visie en een scherpe focus op zijn doelen, volgt hij zijn principes en idealen, ongeacht wat anderen denken. Hij is bereid om risico\'s te nemen en buiten de gebaande paden te denken.',
    typeDescription: 'Een ondernemer-eigenaar is een persoon of bedrijf die vastgoed bezit en gebruikt voor eigen zakelijke doeleinden. Dit vastgoed kan variëren van bedrijfspanden, winkels, fabrieken, tot kantoorgebouwen.',
    kenmerken: [
      'Bezit vastgoed voor eigen zakelijk gebruik en waardecreatie',
      'Vaak met een duidelijke strategische focus voor het bedrijf',
      'Lange termijn horizon, gericht op bedrijfsgroei en vastgoedontwikkeling',
      'Minder afhankelijk van huurders of externe verhuurders',
      'Beheert het vastgoed zelf of met beperkt extern beheer',
      'Actief betrokken bij onderhoud, renovaties en herontwikkelingen'
    ],
    waaromVastgoed: [
      'Zakelijk gebruik: vastgoed ondersteunt de dagelijkse bedrijfsvoering',
      'Langetermijnstabiliteit en bedrijfszekerheid',
      'Kostenbeheersing: eigenaar zijn helpt vaste lasten te beheersen',
      'Waardegroei door renovaties en strategische verbeteringen',
      'Pensioenvoorziening: vastgoed als vermogensopbouw voor later'
    ],
    needToKnow: 'Veel lokale ondernemers die vastgoed in de binnenstad bezitten hebben vaak sterke banden met de lokale gemeenschap. Dit betekent dat ze meer geneigd zijn om samen te werken met de gemeente en andere lokale stakeholders om de leefbaarheid van de buurt te verbeteren.',
    voorbeelden: ['Familiebedrijven met eigendom van bedrijfspanden', 'Professionele winkeleigenaren', 'Bedrijfscampus-eigenaren']
  },
  {
    id: 'NAIEVELING',
    name: 'De Naïeveling',
    type: 'Ondernemer-eigenaar | persoonlijk',
    category: ARCHETYPE_CATEGORIES.ONDERNEMER_PERSOONLIJK,
    order: 8,
    icon: '🌱',
    kernwaarde: 'Passie',
    quote: 'Ik run mijn zaak, geen vastgoedportefeuille. Ik weet alles van mijn vak maar niet van stenen.',
    sleutelwoord: 'Onbevangenheid',
    eigenschappen: ['Vertrouwen', 'Optimist', 'Open blik', 'Onwetend'],
    description: 'De Naïeveling focust vooral op zijn eigen zaak en de dagelijkse praktijk. Hij is niet bezig met strategieën of lange termijn plannen, maar handelt vooral vanuit wat direct nodig is. Zijn aanpak is simpel en praktisch, zonder veel poespas.',
    typeDescription: 'Een ondernemer-eigenaar is een persoon of bedrijf die vastgoed bezit en gebruikt voor eigen zakelijke doeleinden. De diversiteit tussen ondernemer-eigenaren is groot, van zakelijk tot persoonlijk met veel tot weinig of geen kennis van vastgoed.',
    kenmerken: [
      'Bezit vastgoed voor eigen zakelijk gebruik en waardecreatie',
      'Vaak met een duidelijke strategische focus voor het bedrijf',
      'Lange termijn horizon, gericht op bedrijfsgroei',
      'Minder afhankelijk van huurders of externe verhuurders',
      'Beheert het vastgoed zelf of met beperkt extern beheer',
      'Kan actief betrokken zijn bij onderhoud en renovaties'
    ],
    waaromVastgoed: [
      'Zakelijk gebruik: vastgoed ondersteunt de dagelijkse bedrijfsvoering',
      'Lange termijn stabiliteit en bedrijfszekerheid',
      'Kostenbeheersing: eigenaar zijn helpt vaste lasten te beheersen',
      'Waardegroei door renovaties en strategische verbeteringen',
      'Pensioenvoorziening: vastgoed als vermogensopbouw voor later'
    ],
    needToKnow: 'Veel lokale ondernemers die vastgoed in de binnenstad bezitten hebben vaak sterke banden met de lokale gemeenschap. Ze zijn meer geneigd om samen te werken met lokale stakeholders om de leefbaarheid van de buurt te verbeteren.',
    voorbeelden: ['Winkeleigenaren (persoonlijk)', 'Kleine winkel/bedrijfspanden eigenaren']
  },
  {
    id: 'VERNIEUWER',
    name: 'De Vernieuwer',
    type: 'Particuliere investeerder | zakelijk',
    category: ARCHETYPE_CATEGORIES.PARTICULIER_ZAKELIJK,
    order: 9,
    icon: '💡',
    kernwaarde: 'Innovatie',
    quote: 'Ik zie kansen waar anderen ze niet zien. Flexibiliteit en snelle actie zijn mijn kracht om te investeren in de toekomst.',
    sleutelwoord: 'Verandering',
    eigenschappen: ['Flexibel', 'Betrokken', 'Creatief', 'Onafhankelijk'],
    description: 'De Vernieuwer wordt gedreven door een constante zoektocht naar verbetering en groei. Zijn nieuwsgierigheid, persoonlijke betrokkenheid en creatieve benadering stellen hem in staat om buiten de gebaande paden te denken en nieuwe mogelijkheden te ontdekken.',
    typeDescription: 'Een particuliere investeerder is een individu die vastgoed koopt en bezit om financieel rendement te behalen. Dit kan zowel voor persoonlijk gebruik als als investering. De diversiteit is groot, van zakelijk tot persoonlijk.',
    kenmerken: [
      'Belegt vaak op eigen naam met eigen kapitaal',
      'Richt zich op kleinere of middelgrote vastgoedobjecten',
      'Kan zowel actief als passief beheer toepassen',
      'Risicoprofiel varieert van laag tot hoog',
      'Beleggingshorizon is vaak lange termijn',
      'Heeft meer persoonlijke betrokkenheid dan institutionele investeerders'
    ],
    waaromVastgoed: [
      'Huurinkomsten genereren: stabiele, regelmatige inkomsten',
      'Waardegroei realiseren door marktontwikkelingen en renovaties',
      'Kapitaalbehoud: vermogen op lange termijn beschermen',
      'Flexibiliteit in beleggingen voor privé en investering',
      'Risicospreiding als aanvulling op andere beleggingscategorieën'
    ],
    needToKnow: 'Particuliere investeerders beginnen vaak met vastgoed als manier om vermogen op te bouwen. Ze kunnen flexibeler reageren op marktomstandigheden dan grotere institutionele beleggers en staan vaak open voor vernieuwing en innovatieve vastgoedontwikkelingen.',
    voorbeelden: ['Particuliere woningbezitters', 'Commerciële vastgoedbezitters', 'Horeca vastgoedbezitters']
  },
  {
    id: 'ONSCHULDIGE',
    name: 'De Onschuldige',
    type: 'Particuliere investeerder | persoonlijk',
    category: ARCHETYPE_CATEGORIES.PARTICULIER_PERSOONLIJK,
    order: 10,
    icon: '🕊️',
    kernwaarde: 'Zekerheid',
    quote: 'Ik wacht af en afhankelijk van de situatie reageer ik. Pas als het echt nodig is, kom ik in actie.',
    sleutelwoord: 'Eenvoud',
    eigenschappen: ['Naïef', 'Afwachtend', 'Positief', 'Onervaren'],
    description: 'De Onschuldige is iemand die zich niet actief bezighoudt met strategische keuzes en toekomstplannen. Hij benadert situaties zonder veel voorkennis of ervaring en laat ontwikkelingen vaak op zich afkomen. Hij straalt een rustige, eenvoudige benadering uit.',
    typeDescription: 'Een particuliere investeerder is een individu die vastgoed koopt en bezit om financieel rendement te behalen. De diversiteit is groot, van zakelijk tot persoonlijk met veel tot weinig of geen kennis van vastgoed.',
    kenmerken: [
      'Belegt vaak op eigen naam met eigen kapitaal',
      'Richt zich op kleinere of middelgrote vastgoedobjecten',
      'Kan zowel actief als passief beheer toepassen',
    ...
    needToKnow: 'Particuliere investeerders beginnen vaak met vastgoed als manier om vermogen op te bouwen. Ze kunnen flexibeler reageren op marktomstandigheden dan grotere institutionele beleggers.',
    voorbeelden: ['Particuliere woningbezitters', 'Commerciële vastgoedbezitters', 'Horeca vastgoedbezitters']
  },
  {
    id: 'BEMIDDELAAR',
    name: 'De Bemiddelaar',
    type: 'Gemeente | eigenaar/gebruiker-beheerder',
    category: ARCHETYPE_CATEGORIES.GEMEENTE_BEHEERDER,
    order: 11,
    icon: '⚖️',
    kernwaarde: 'Verbinding',
    quote: 'Het is mijn rol om mensen en belangen met elkaar te verbinden om zo samen tot gedragen en duurzame oplossingen te komen.',
    sleutelwoord: 'Verbinding',
    eigenschappen: ['Empathisch', 'Geduldig', 'Neutraal', 'Probleemoplossend'],
    description: 'De Bemiddelaar is gericht op het vinden van evenwicht tussen uiteenlopende belangen en het creëren van ruimte voor samenwerking. Hij luistert zorgvuldig naar alle partijen en bevordert open communicatie om begrip en vertrouwen te vergroten.',
    typeDescription: 'Een gemeente is een publieke instelling die onroerend goed bezit en beheert in het kader van haar gemeentelijke taken, zoals het bieden van publieke voorzieningen en het faciliteren van maatschappelijke doelen.',
    kenmerken: [
      'Belegt vaak met publiek kapitaal in vastgoedobjecten',
      'Richt zich op grotere vastgoedobjecten met maatschappelijke waarde',
      'Past actief beheer toe, met focus op functionaliteit en bereikbaarheid',
      'Risicoprofiel varieert afhankelijk van type vastgoed en maatschappelijke functie',
      'Beleggingshorizon is vaak lange termijn, gericht op stabiliteit'
    ],
    waaromVastgoed: [
      'Publieke dienstverlening: vastgoed voor diensten aan inwoners',
      'Woonbehoefte invullen: sociale woningbouw en betaalbare huisvesting',
      'Wijkontwikkeling: investeren in leefbaarheid en stedelijke vernieuwing',
      'Maatschappelijke waarde creëren: integratie, economische groei',
      'Langdurige waarde behouden en opbouwen'
    ],
    needToKnow: 'Gemeenten bezitten vaak vastgoed als middel om te zorgen voor de lange termijn ontwikkeling van de stad of regio, maar ze zijn ook vaak actief in het stimuleren van stedelijke vernieuwing en de transformatie van verouderde gebieden.',
    voorbeelden: ['Gemeente Amsterdam', 'Gemeente Rotterdam', 'Gemeente Utrecht', 'Gemeente Den Haag']
  },
  {
    id: 'REGISSEUR',
    name: 'De Regisseur',
    type: 'Gemeente | ontwikkelaar',
    category: ARCHETYPE_CATEGORIES.GEMEENTE_ONTWIKKELAAR,
    order: 12,
    icon: '🎬',
    kernwaarde: 'Publieke waarde',
    quote: 'Het is mijn taak om de belangen van de stad voorop te stellen en een duurzame ontwikkeling te waarborgen.',
    sleutelwoord: 'Publieke waarde',
    eigenschappen: ['Verbindend', 'Coördinerend', 'Verantwoordelijk', 'Pragmatisch'],
    description: 'De Regisseur wordt gedreven door het vermogen om verschillende belangen en processen effectief te coördineren en te verbinden. Hij richt zich op het realiseren van concrete en haalbare doelen, waarbij hij de nodige afstemming tussen partijen zoekt.',
    typeDescription: 'Een gemeente is een publieke instelling die onroerend goed bezit en beheert in het kader van haar gemeentelijke taken, zoals het bieden van publieke voorzieningen en het faciliteren van maatschappelijke doelen.',
    kenmerken: [
      'Belegt vaak met publiek kapitaal in vastgoedobjecten',
      'Richt zich op grotere vastgoedobjecten met maatschappelijke waarde',
...
// ==========================================
// ARCHETYPE HELPER FUNCTIES
// ==========================================

/**
 * Get all archetypes
 * @returns {object[]} All 12 archetypes
 */
...
/**
 * Get archetype by ID
 * @param {string} id - Archetype ID (e.g., 'STRATEEG', 'NAVIGATOR')
...
/**
 * Get archetype by category
 * @param {string} category - Category from ARCHETYPE_CATEGORIES
 * @returns {object|null} Archetype or null
 */
function getArchetypeByCategory(category) {
  return ARCHETYPES.find(a => a.category === category) || null;
}

/**
 * Search archetypes by keyword
 * @param {string} term - Search term
 * @returns {object[]} Matching archetypes
 */
function searchArchetypes(term) {
...
/**
 * Map an existing VASTGOED actor to a likely archetype
 * @param {string} actorId - Actor ID from ACTORS array
 * @returns {object[]} Suggested archetypes with relevance
 */
function suggestArchetypesForActor(actorId) {
  const actorArchetypeMap = {
    'KLEINE_VASTGOEDONDERNEMER': ['REBEL', 'NAIEVELING', 'VERNIEUWER', 'ONSCHULDIGE'],
    'GROTE_VASTGOEDBELEGGER': ['STRATEEG', 'NAVIGATOR', 'BESCHERMER'],
    'PROJECTONTWIKKELAAR': ['JAGER', 'VERNIEUWER', 'NAVIGATOR'],
    'AANDEELHOUDER_INVESTEERDER': ['STRATEEG', 'NAVIGATOR', 'JAGER']
  };

  const archetypeIds = actorArchetypeMap[actorId] || [];
  return archetypeIds.map(id => getArchetypeById(id)).filter(a => a !== null);
}
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    ...
    getAllArchetypes,
    getArchetypeById,
    getArchetypeByCategory,
    searchArchetypes,
    suggestArchetypesForActor
  };
}
